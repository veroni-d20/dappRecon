  ...
  return (
    <Layout pageTitle="Search Your dapp">
      ...
      <div className="mt-5">
        <Link
          href={"/register"}
          className="relative block w-full rounded-lg border-2 border-dashed border-gray-300 p-12 text-center hover:border-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2"
        >
          <svg
